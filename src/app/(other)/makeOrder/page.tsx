...
const OrderPage = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row md:space-x-8 px-8 py-10 bg-blue-50">
      <Script src="https://checkout.razorpay.com/v1/checkout.js" />

      {/* Account Section */}
      <div className="flex-grow">
        <div className="bg-white p-8 mb-8 rounded-xl shadow-md border border-gray-200">
          <h2 className="text-3xl font-semibold mb-4 text-gray-900">Account</h2>
        ...
        <div className="bg-white p-8 mb-8 rounded-xl shadow-md border border-gray-200">
          ...
          <Button
            variant="outline"
            className="border border-blue-500 py-2 px-5 rounded-lg text-blue-600 hover:bg-blue-100"
        ...
        <div className="bg-white p-8 rounded-xl shadow-md border border-gray-200">
          <h2 className="text-3xl font-semibold mb-4 text-gray-900">Payment</h2>
          <div className="mb-3">
            <input
              type="radio"
              id="cod"
      ...
      <div className="md:w-1/3 bg-white p-8 rounded-xl shadow-lg border border-gray-300">
        <h2 className="text-3xl font-semibold mb-4 text-gray-900">
          Order Summary
        </h2>
        <div className="mb-4 bg-blue-50 p-5 rounded-lg shadow-inner">
          ...
          <p className="text-lg flex justify-between text-gray-700">
            <span>Shipping:</span> <span>₹{cart.deliveryCharges}</span>
          </p>
          <p className="text-xl font-bold flex justify-between border-t border-gray-300 pt-3 text-gray-900">
            <span>Total:</span> <span>₹{cart.payablePrice.toFixed(2)}</span>
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center">
            {isEditable ? (
              ...
              <p
                className="flex-grow bg-blue-100 border border-gray-300 rounded-lg py-2 px-4 text-gray-800 cursor-pointer"
          ...
          {showGiftMessage && (
            <p className="mt-2 text-blue-600 font-medium">
              Congratulations! A surprise gift is on its way.
            </p>
          )}
        </div>
