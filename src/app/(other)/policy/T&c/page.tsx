...
const TermsAndConditions: React.FC = () => {
  return (
    <>
      <Head>
        <title>Terms and Conditions | Loom n Bllom</title>
        <meta
          name="description"
          content="Terms and Conditions for Loom n Bloom"
        />
      </Head>
      ...
      <div className="max-w-7xl mx-auto p-6 bg-white shadow-lg">
        <header className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Welcome to Loom n Bloom. Please read these terms and conditions
        ...
        <section className="space-y-8">
          ...
          <div>
            ...
            <p className="text-lg text-gray-700">
              ...
              images, and other materials, is owned by Loom n Bloom or its
