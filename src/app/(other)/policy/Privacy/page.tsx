...
const PrivacyPolicy: React.FC = () => {
  return (
    <>
      <Head>
        <title>Privacy Policy | Loom n Bloom</title>
        <meta name="description" content="Privacy Policy for Loom n Bloom" />
      </Head>
      ...
      <div className="max-w-7xl mx-auto p-6 bg-white shadow-lg">
        <header className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Please read our privacy policy carefully before using The Loom n
            Bloom website.
          </p>
        </header>
        ...
        <section className="space-y-8">
          <div>
            ...
            <p className="text-lg text-gray-700">
              ...
              Loom n Bloom. While you can browse some sections of our site
          ...
          <div>
            ...
            <p className="text-lg text-gray-700">
              ...
              information. Loom n Bloom is not responsible for the privacy
