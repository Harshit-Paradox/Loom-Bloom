    ...
    <li>
      <NavigationMenuLink asChild>
        <a
          ref={ref}
          className={cn(
            "flex flex-row select-none space-y-1 rounded-md p-3 leading-none no-underline text-black outline-none transition-colors hover:bg-accent focus:bg-accent focus:text-black",
            className
          )}
          {...props}
        >
